...
- **API rate limit:** 600 requests/minute per IP. So you can technically create 600 posts per minute.
...
- **Analytics:** Deleted after 40 days. Fetch daily if you're building reports.
