---
title: Glossary
description: "Glossary of terms used widely in social media marketing and APIs, from engagement rate and reach to webhooks, OAuth scopes, and rate limiting."
icon: book-open
keywords: ["social media glossary", "api glossary", "social media terms", "social media api terminology"]
"og:title": "Social Media Glossary - Marketing & API Terms Explained"
"og:description": "Comprehensive glossary of social media marketing and API terms. Learn the terminology used in social media management."
---
