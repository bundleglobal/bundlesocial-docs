---
title: Discord
description: "Channel-based messaging via webhooks, not OAuth. Requires a channelId on every post, and supports custom bot identity and media attachments."
icon: discord
keywords: ["discord api", "discord webhooks", "discord bot api", "social media api", "discord automation", "discord post scheduling"]
"og:title": "Discord API Integration - Webhooks & Channel Messaging"
"og:description": "Discord API guide: Post messages via webhooks, custom bot identity, channel selection, and media attachments."
---
