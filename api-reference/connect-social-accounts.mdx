...
- `showModalOnConnectSuccess` - (optional) Whether to show a modal on connect success that asks what to do next - go back to the page provided in the `redirectUrl` parameter or just close the modal and let the user connect more accounts.
- `maxSocialAccountsConnected` - (optional) The maximum number of social accounts that can be connected.
...
- threads-not-enought-permissions - You didn't grant all the necessary permissions

- mastodon-callback - Error connecting Mastodon
- mastodon-not-enought-permissions - You didn't grant all the necessary permissions

- bluesky-callback - Error connecting Bluesky
- bluesky-not-enought-permissions - You didn't grant all the necessary permissions

- google-businnes-callback - Error connecting Google Business
...
- google-businnes-callback - Google Business connected successfully