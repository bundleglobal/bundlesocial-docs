---
title: Introduction
description: "Get started with the bundle.social API. API key auth via x-api-key, the base URL, how organizations and teams fit together, and where rate limits bite."
