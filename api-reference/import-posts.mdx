...
description: "Pull past posts and analytics from Instagram, TikTok, LinkedIn and more. An async job backfills your dashboard with history from before you connected."
...
Use the History Import API to fetch existing content from connected accounts and populate your dashboard with past posts.
...
Need comment import and replies? See [Comments API](/api-reference/comments).
...
Want to enable this? [Contact us](https://bundle.social/contact) and we'll set it up for your organization. Additional platform usage fees may apply.
</Warning>
