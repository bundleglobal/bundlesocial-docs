...
### Google review imports (monthly, per social account)

Maximum Google reviews imported from each connected Google Business Profile per month. Counter resets on the 1st of each month.

| Tier | Reviews / account / month |
| ---- | ------------------------- |
| FREE | 5 |
| PRO | 200 |
| BUSINESS | 200 |

A single Google review import request is additionally capped at **250 reviews** (hard cap, not overridable).
