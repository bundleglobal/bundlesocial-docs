...
- [Snapchat analytics](/api-reference/platforms/snapchat#analytics)
...
| Snapchat | Optional | Optional | Public Profile, Story, and Spotlight stats when raw Snapchat analytics is enabled for the organization |
...
| [Snapchat](/api-reference/platforms/snapchat) | Lifetime | Lifetime | Public Profile required; raw payloads require organization-level enablement |
