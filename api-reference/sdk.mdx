---
title: SDK
description: "Don't reinvent the wheel. Our typed TypeScript SDK for Node.js handles auth headers and the boring parts, and there is a CLI and MCP server too."
icon: box-open
