---
title: Health
description: "Check API and platform health before sending users into broken flows. GET /api/v1 returns live per-platform status so you can disable what is down."
icon: heart-pulse
