...
Now you can see your **Media Library** dashboard. To upload something, either click on the **gray** area or just drop it there. You can also **paste a public URL** in the upload flow so we fetch the file for you (**1 GB** max, **60 second** download window-see [Media Upload](/api-reference/upload-content#upload-from-a-url)).
