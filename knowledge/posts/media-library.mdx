...
description: Learn how to use the Media Library in bundle.social to store, organize, and manage your social media content. Upload, filter, and track used vs unused media.
keywords: ["media library", "social media management", "social media media upload", "image video management"]
"og:title": "Media Library Guide - bundle.social"
"og:description": "Complete guide to using the Media Library in bundle.social for storing and organizing your social media content."
---
...
Now you can see your **Media Library** dashboard. To upload something, either click on the **gray** area or just drop it there. You can also **paste a public URL** in the upload flow so we fetch the file for you (same **60 second** download window as elsewhere-see [Media Upload](/api-reference/upload-content#upload-from-a-url-dashboard)).
